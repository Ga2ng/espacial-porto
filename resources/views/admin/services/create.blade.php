...
<section class="section-padding">
    <div class="container">
        <div class="mb-4">
            <h1 class="section-title mb-0">Tambah Layanan</h1>
            <p class="section-subtitle">Isi form di bawah untuk menambahkan layanan baru di landing page.</p>
        </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="icon" id="icon" class="form-control"
                               value="{{ old('icon', 'fas fa-cog') }}" placeholder="contoh: fas fa-map-marked-alt">
                    </div>
